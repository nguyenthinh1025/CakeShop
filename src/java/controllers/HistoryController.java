...
public class HistoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String useID = account.getUserID();
        try {
            OrderDAO productDao = new OrderDAO();
            OrderDetailDAO productDaoDe = new OrderDetailDAO();
            ArrayList<OrderDTO> list = productDao.listOrderID(useID);
            if (list != null) {
                productDaoDe.getListDetailByOrderID(useID);
